...
import { getEasterSunday, getJulianEaster, getOrthodoxEaster, getWesternEaster } from "@/calendar/temporal/mod.ts";
...
Deno.test("getEasterSunday function", async (t) => {
  ...
  await t.step("Error cases", async (t) => {
    ...
    await t.step("Throws for non-numeric input", () => {
      assertThrows(() => getEasterSunday("2023" as unknown as number), RangeError);
    });
...
Deno.test("getWesternEaster function", async (t) => {
  ...
  await t.step("Error cases", async (t) => {
    ...
    await t.step("Throws for non-numeric input", () => {
      assertThrows(() => getWesternEaster("2023" as unknown as number), RangeError);
    });
...
Deno.test("getJulianEaster function", async (t) => {
  ...
  await t.step("Error cases", async (t) => {
    ...
    await t.step("Throws for non-numeric input", () => {
      assertThrows(() => getJulianEaster("2023" as unknown as number), RangeError);
    });
...
Deno.test("getOrthodoxEaster function", async (t) => {
  ...
  await t.step("Error cases", async (t) => {
    ...
    await t.step("Throws for non-numeric input", () => {
      assertThrows(() => getOrthodoxEaster("2023" as unknown as number), RangeError);
    });
